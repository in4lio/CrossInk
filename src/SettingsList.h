  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    add(SettingInfo::Enum(StrId::STR_SHORT_PWR_BTN, &CrossPointSettings::shortPwrBtn,
                          {StrId::STR_IGNORE, StrId::STR_SLEEP, StrId::STR_PAGE_TURN, StrId::STR_TOGGLE_BOOKMARK,
                           ...
                           StrId::STR_CALIBRE_WIRELESS, StrId::STR_JOIN_NETWORK, StrId::STR_CREATE_HOTSPOT,
                           StrId::STR_SCREENSHOT_BUTTON, StrId::STR_READER_DARK_MODE, StrId::STR_FOOTNOTES,
                           StrId::STR_BROWSE_FILES, StrId::STR_CHANGE_FONT_SIZE},
            ...
            .withEnumRawValues({CrossPointSettings::IGNORE, CrossPointSettings::SLEEP, CrossPointSettings::PAGE_TURN,
                                ...
                                CrossPointSettings::CALIBRE_WIRELESS, CrossPointSettings::JOIN_NETWORK,
                                CrossPointSettings::CREATE_HOTSPOT, CrossPointSettings::SCREENSHOT,
                                CrossPointSettings::TOGGLE_DARK_MODE, CrossPointSettings::FOOTNOTES,
                                CrossPointSettings::FILE_BROWSER, CrossPointSettings::CHANGE_FONT_SIZE}));
